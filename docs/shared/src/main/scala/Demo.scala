...
//    import sRGB.*
//
//    val commonSpaces: Seq[ColorSpace[?]] = Seq[ColorSpace[?]](RGB, ARGB32, ARGB64, RGBA32, RGBA64, CMYK, HSL, HSV, XYZ, Lab, Luv)
//
...
//          br,
//          table(
//            tr(td("Random Color"), td("Nearest Match from Palette"), td(s"Distance in $space ColorSpace")),
//            (1 to 10).map(_ => {
